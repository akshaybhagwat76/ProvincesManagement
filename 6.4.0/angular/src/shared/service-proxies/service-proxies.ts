...
export class StateServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | null | undefined, stateName: string | null | undefined, countryName: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<StateDtoPagedResultDto> {
...
export class GetStateForViewDto implements IGetStateForViewDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.stateName = _data["stateName"] ? StateDto.fromJS(_data["stateName"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["stateName"] = this.stateName ? this.stateName.toJSON() : <any>undefined;
        return data; 
    }
